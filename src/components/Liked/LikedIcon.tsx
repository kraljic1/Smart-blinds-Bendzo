          ...
          {likedItems.length === 0 ? (
            ...
            <div className="max-h-64 overflow-y-auto">
              {likedItems.slice(0, 3).map((product) => (
                <div key={product.id} className="p-3 border-b border-gray-100 dark:border-gray-800 flex items-center">
                  <img 
                    src={product.image} 
                    alt={product.name} 
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <p className="text-xs text-blue-600 dark:text-blue-400">${product.price}</p>
                  </div>
                </div>
              ))}
