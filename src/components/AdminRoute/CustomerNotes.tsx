...
const SystemNotes: React.FC<SystemNotesProps> = ({ notes }) => {
 ...
 return (
 <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg overflow-hidden border border-blue-200">
 <div className="px-4 py-5 sm:px-6 border-b border-blue-200 bg-blue-100 dark:bg-blue-800/30">
 <div className="flex items-center">
