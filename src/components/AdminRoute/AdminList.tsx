...
const AdminList: React.FC<AdminListProps> = ({
 ...
 <p className="mt-2 text-sm text-gray-500">Učitavanje administratora...</p>
 </div>
 ) : admins.length === 0 ? (
 <div className="px-4 py-12 text-center">
 <AlertCircle className="mx-auto h-12 w-12 text-gray-400"/>
 <h3 className="mt-2 text-sm font-medium text-gray-900">Nema administratora</h3>
 <p className="mt-1 text-sm text-gray-500">Dodajte administratora za početak.</p>
 </div>
 ) : (
