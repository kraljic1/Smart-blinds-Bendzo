    ...
    <div className="flex-1">
      ...
      <div className="relative rounded-md shadow-sm">
        ...
        <input
          type="email"
          id={id}
          className={`block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none ${focusClasses} sm:text-sm`}
