  ...
  return (
    <>
      ...
      <div className="form-group">
        <label htmlFor="payment-method-display">Odabrani način plaćanja</label>
        <div id="payment-method-display" className="payment-method-fixed" role="textbox" aria-readonly="true" tabIndex={0}>
