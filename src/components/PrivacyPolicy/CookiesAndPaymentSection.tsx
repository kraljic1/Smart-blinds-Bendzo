...
const CookiesAndPaymentSection: React.FC = () => {
 ...
 <h2 className="text-2xl mb-4 text-gray-900">7. Kolačići i tehnologije praćenja</h2>
 <p className="text-gray-800">Koristimo kolačiće i slične tehnologije praćenja za prikupljanje i praćenje informacija o vašim aktivnostima pregledavanja. Kolačićima možete upravljati putem postavki vašeg preglednika.</p>
 <p className="text-gray-800">Vrste kolačića koje koristimo:</p>
 ...
 <h3 className="text-xl mb-2 mt-4 text-gray-900">7.1 Stripe kolačići za plaćanje</h3>
 <p className="text-gray-800">Za procesiranje plaćanja karticom koristimo Stripe, vodeći svjetski servis za sigurno procesiranje plaćanja. Stripe postavlja kolačiće koji su neophodni za:</p>
 <ul className="list-disc pl-5 mb-4 text-gray-800">
 ...
 <section className="mb-10">
 <h2 className="text-2xl mb-4 text-gray-900">8. Procesiranje plaćanja i treće strane</h2>
 <p className="text-gray-800">Za sigurno procesiranje plaćanja koristimo Stripe Inc., certificirani PCI DSS Level 1 pružatelj usluga plaćanja.</p>
 
 <h3 className="text-xl mb-2 mt-4 text-gray-900">8.1 Stripe procesiranje plaćanja</h3>
 <p className="text-gray-800">Kada odaberete plaćanje karticom:</p>
 <ul className="list-disc pl-5 mb-4 text-gray-800">
 ...
 <h3 className="text-xl mb-2 mt-4 text-gray-900">8.2 Podaci dijeljeni sa Stripe-om</h3>
 <p className="text-gray-800">Sa Stripe-om dijelimo sljedeće informacije potrebne za procesiranje plaćanja:</p>
 <ul className="list-disc pl-5 mb-4 text-gray-800">
 ...
 <h3 className="text-xl mb-2 mt-4 text-gray-900">8.3 Stripe politika privatnosti</h3>
 <p className="text-gray-800">
