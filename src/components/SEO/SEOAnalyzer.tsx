...
const SEOAnalyzer: React.FC<SEOAnalyzerProps> = ({ showResults = false }) => {
 ...
 return (
 <div className="seo-analyzer fixed bottom-4 right-4 p-4 bg-white shadow-lg rounded-lg border border-gray-300 z-50 max-w-md overflow-auto max-h-[60vh] hidden lg:block">
