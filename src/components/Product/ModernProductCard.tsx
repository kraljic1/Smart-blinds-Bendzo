...
const ModernProductCard: React.FC<ModernProductCardProps> = ({ 
  ...
  return (
    <div className="group h-full overflow-hidden">
      ...
      <div 
        ref={cardRef} 
        className={`relative h-full flex flex-col light-card dark:bg-gray-800 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-600 transition-all duration-500 group-hover:shadow-xl cursor-pointer ${styles.productCard} ${isVisible ? styles.productCardVisible : ''} ${getDelayClass()}`}
