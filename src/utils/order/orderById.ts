...
/**
 * Fetches order data directly from Supabase in development mode
 */
const fetchOrderFromSupabase = async (orderId: string): Promise<TransformedOrderData | null> => {
...
/**
 * Fetches order data from Netlify function in production mode
 */
const fetchOrderFromNetlify = async (orderId: string): Promise<TransformedOrderData | null> => {
...
export const getOrderById = async (orderId: string): Promise<TransformedOrderData | null> => {
 ...
 return await fetchOrderFromSupabase(orderId);
 } else {
 return await fetchOrderFromNetlify(orderId);
 }
