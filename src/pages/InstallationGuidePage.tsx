...
"Keep the manual handy"
 ...
 <div className="mb-12">
 <h1 className="text-4xl font-bold text-gray-900 mb-4">Quick Installation Guide</h1>
 <p className="text-xl text-gray-600">Follow these steps to install your smart blinds safely and correctly</p>
 </div>
 ...
 <div>
 <h3 className="text-xl font-bold text-gray-900 mb-4">Important Tips</h3>
