  ...
  return (
    <div className="pt-24 pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Connect to Home</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300">Set up your smart blinds with your home network in three easy steps</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-300 mb-6">Ready to start controlling your smart blinds?</p>
          <Link
